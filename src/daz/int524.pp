...
\begin{description}
\item[Issues 1.1 (2004/01/19)]  Test for 𝕌
...
a(rewrite_tac[z_get_specⓩAoW⌝, z_gen_pred_elim[ⓩ𝕌⌝] (z_get_specⓩAoTuI⌝)]);
store_mt_results
mt_run
...
ⓈCN
 (CODE1) ⊑ Δ AoV, X[X.I = 42 ∧ AoV = X]	(CODE2)
■
...
a(cn_vc_simp_tac[]);
a(rewrite_tac[ z_gen_pred_elim [ⓩ 𝕌 ⦂ ℙℤ ⌝] (z_get_specⓩAoTuI⌝) ]);
store_mt_results
mt_run
