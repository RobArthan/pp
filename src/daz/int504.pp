...
\def\Title{Z Documents Test Material}

\def\AbstractText{This document gives four compliance notation scripts. The Z documents generated by these scripts are checked against the original scripts.}

\def\Reference{ISS/HAT/DAZ/INT504}
...
%% LaTeX2e port: \TPPtitle{Z Documents Test Material}  %% Mandatory field
%% LaTeX2e port: \def\TPPheadtitle{Z Documents Test Material}
%% LaTeX2e port: \TPPref{ISS/HAT/DAZ/INT504}  %% Mandatory field
...
%% LaTeX2e port: This document gives four compliance notation scripts.  The Z documents generated by these scripts are checked against the original scripts.
%% LaTeX2e port: }
