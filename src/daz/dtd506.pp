...
********************************************************************************
% dtd506.doc   ℤ $Date: 2002/10/17 15:46:52 $ $Revision: 1.12 $ $RCSfile: dtd506.doc,v $
=TEX
...
%% LaTeX2e port: \TPPtitle{Detailed Design: VC Browser}  %% Mandatory field
%% LaTeX2e port: \TPPref{ISS/HAT/DAZ/DTD506}  %% Mandatory field
