...
********************************************************************************
% mdt501.doc    ℤ $Date: 2008/10/26 12:50:19 $ $Revision: 1.23 $ $RCSfile: mdt501.doc,v $
=TEX
...
\def\Title{Module Tests: Compliance Notation Lexical Analyser}

\def\AbstractText{This document comprises test cases for testing the DAZ Compliance Notation Lexical Analyser as described in the document ISS/HAT/DAZ/DTD501.}

\def\Reference{ISS/HAT/DAZ/MDT501}
...
%% LaTeX2e port: \TPPtitle{Module Tests: Compliance Notation Lexical Analyser}  %% Mandatory field
%% LaTeX2e port: \TPPref{ISS/HAT/DAZ/MDT501}    %% Mandatory field
...
%% LaTeX2e port: \TPPabstract{This document comprises test cases for testing the DAZ Compliance Notation Lexical Analyser as described in the document ISS/HAT/DAZ/DTD501.}
%% LaTeX2e port: 
...
local
    ...
    val a7 = [(LCGrkDelta, CNText "Δ"), (LCZ, CNZ [ZTId "abc", ZTEos]),
     (LCLSqBrack, CNText "[")] : CNTypes.CN_LEX_ITEM list;
    val a8 = [(LCGrkDelta, CNText "Δ"), (LCZ, CNZ [ZTId "abc", ZTEos]),
     (LCLBrace, CNText "{")] : CNTypes.CN_LEX_ITEM list;
    val a9 = [(LCGrkDelta, CNText "Δ"), (LCZ, CNZ [ZTId "abc", ZTEos]),
     (LCLSqBrack, CNText "["),
