...
********************************************************************************
% imp511.doc   ℤ $Revision: 1.34 $ $RCSfile: imp511.doc,v $ $Date: 2007/01/23 15:59:32 $
=TEX
...
\def\Title{Implementation: Z Output Function}

\def\AbstractText{This document contains the implementation for the Z output function.}

\def\Reference{ISS/HAT/DAZ/IMP511}
...
%% LaTeX2e port: \TPPtitle{Implementation: Z Output Function}  %% Mandatory field
%% LaTeX2e port: \TPPref{ISS/HAT/DAZ/IMP511}  %% Mandatory field
%% LaTeX2e port: \def\SCCSversion{$Revision: 1.34 $%
%% LaTeX2e port: }
%% LaTeX2e port: \TPPissue{\SCCSversion}  %% Mandatory field
%% LaTeX2e port: \TPPdate{\FormatDate{$Date: 2007/01/23 15:59:32 $%
%% LaTeX2e port: }}
...
%% LaTeX2e port: This document contains the implementation for the Z output function.}
		...
		val p = (let val (root, parts) = strip_app c;
			in
				if ((fst(dest_const root) = "ConstSpec")
					 handle Fail _ => false)
				then ((snd o dest_eq o concl o β_conv o
					mk_app)
