...
********************************************************************************
%  dtd518.doc ℤ $Date: 2002/10/17 15:46:52 $ $Revision: 1.16 $ $RCSfile: dtd518.doc,v $
=TEX
...
Γ ⊢ t
=TEX
\ has been found, all of whose assumptions, Γ, are contained (up to $\alpha$-convertibility) in the list $hyps$.
\\\hline
