...
********************************************************************************
% ℤ $Date: 2006/09/19 11:25:02 $ $Revision: 1.19 $ $RCSfile: wrk503.doc,v $
=TEX
...
package body PACK_P is
   ...
   procedure CUBE_ROOT (N : in out INTEGER)
    ...
    Δ N, J [N ≥ 0, N ** 3 ≤ N⋎0 < (N + 1) ** 3]

   is
      L : INTEGER;
   begin

      Δ N, J, L [N ≥ 0, N ** 3 ≤ N⋎0 < (N + 1) ** 3]	(2)
