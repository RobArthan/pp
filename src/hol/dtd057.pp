...
********************************************************************************
% dtd057.doc  ℤ $Date: 2002/10/17 15:10:58 $ $Revision: 1.8 $ $RCSfile: dtd057.doc,v $
=TEX
...
=FAILURE
57001	?0 is not of the form: ⌜ⓜmk_ℕ m⌝ ≤ ⓜmk_ℕ n⌝⌝
57002	?0 is not of the form: ⌜ⓜmk_ℕ m⌝ ≥ ⓜmk_ℕ n⌝⌝
57003	?0 is not of the form: ⌜ⓜmk_ℕ m⌝ Div ⓜmk_ℕ n⌝⌝
57004	?0 is not of the form: ⌜ⓜmk_ℕ m⌝ > ⓜmk_ℕ n⌝⌝
57005	?0 is not of the form: ⌜ⓜmk_ℕ m⌝ < ⓜmk_ℕ n⌝⌝
57006	?0 is not of the form: ⌜ⓜmk_ℕ m⌝ - ⓜmk_ℕ n⌝⌝
57007	?0 is not of the form: ⌜ⓜmk_ℕ m⌝ Mod ⓜmk_ℕ n⌝⌝
6085	?0 is not of the form: ⌜ⓜmk_ℕ m⌝ + ⓜmk_ℕ n⌝⌝
57009	?0 is not of the form: ⌜ⓜmk_ℕ m⌝ * ⓜmk_ℕ n⌝⌝
...
$⌜T⌝$ or $⌜F⌝$.
=FAILURE
57100	?0 is not of the form: ⌜ⓜmk_ℕ m⌝ = ⓜmk_ℕ n⌝⌝
=SEEALSO
Proof context $comb$
=ENDDOC
\section{CHARACTERS}
...
=FAILURE
57510	?0 is not of type ⓣℕ⌝
57511	?1 is not of type ⓣℕ⌝
=ENDDOC
=DOC
