%  dtd038.doc  ℤ $Date$ $Revision$ $RCSfile$
=TEX
...
\def\Title{Zorn's Lemma and Cardinality}

\def\AbstractText{This document contains the detailed design for further theorems about sets.}

\def\Reference{DS/FMU/IED/DTD092}
...
%% LaTeX2e port: \TPPtitle{Zorn's Lemma and Cardinality}  %% Mandatory field
%% LaTeX2e port: \TPPref{DS/FMU/IED/DTD092}  %% Mandatory field
...
%% LaTeX2e port: This document contains the detailed design for further theorems
