...
********************************************************************************
% dtd032.doc   ℤ $Date: 2008/04/18 09:29:29 $ $Revision: 2.11 $ $RCSfile: dtd032.doc,v $
...
\def\Title{Detailed Design of the HOL Pretty Printer}

\def\AbstractText{This document defines the HOL pretty printing functions and the format of their output.}

\def\Reference{DS/FMU/IED/DTD032}
...
%% LaTeX2e port: =TEX
%% LaTeX2e port: % dtd032.doc   ℤ $Date: 2008/04/18 09:29:29 $ $Revision: 2.11 $ $RCSfile: dtd032.doc,v $
%% LaTeX2e port: \documentstyle[hol1,11pt,TQ]{article}
%% LaTeX2e port: 
%% LaTeX2e port: \TPPtitle{Detailed Design of the HOL Pretty Printer}
%% LaTeX2e port: \TPPref{DS/FMU/IED/DTD032}
%% LaTeX2e port: \def\SCCSissue{$Revision: 2.11 $%
%% LaTeX2e port: }
%% LaTeX2e port: \TPPissue{\SCCSissue}
%% LaTeX2e port: \TPPdate{\FormatDate{$Date: 2008/04/18 09:29:29 $%
%% LaTeX2e port: }}
...
%% LaTeX2e port: 
%% LaTeX2e port: make -f rel001.mkf dtd032.dvi
%% LaTeX2e port: doctex dtd032
%% LaTeX2e port: texdvi dtd032
%% LaTeX2e port: bibtex dtd032
%% LaTeX2e port: doctex dtd032 ; texdvi dtd032
%% LaTeX2e port: doctex dtd032 ; texdvi dtd032 ; bibtex dtd032
%% LaTeX2e port: dvipage dtd032 &
%% LaTeX2e port: 
%% LaTeX2e port: 
%% LaTeX2e port: docsml dtd032
%% LaTeX2e port: use_file "dtd032.sml";
%% LaTeX2e port: 
%% LaTeX2e port: lasp -s dtd032.doc > zz1
%% LaTeX2e port: lasp -s -U dtd032.doc > zz1
%% LaTeX2e port: 
%% LaTeX2e port: =TEX
...
%% LaTeX2e port: \TPPabstract{This document defines the HOL pretty
%% LaTeX2e port: 	printing functions and the format of their
%% LaTeX2e port: 	output.}
...
:> strip_let it;
val it = ([[(⌜$e⌝, ⌜λ a b⦁ c⌝)]], ⌜d e f⌝) : (TERM * TERM) list list * TERM
