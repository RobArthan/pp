...
********************************************************************************
% mdt022.doc   ℤ $Date: 2002/10/17 15:10:58 $ $Revision: 1.6 $ $RCSfile: mdt022.doc,v $
...
%% LaTeX2e port: =TEX
%% LaTeX2e port: % mdt022.doc   ℤ $Date: 2002/10/17 15:10:58 $ $Revision: 1.6 $ $RCSfile: mdt022.doc,v $
...
("term_recogniser.1", (fn x=> x), ⌜λx ⦁ T⌝ , ⌜λx ⦁ T⌝),
