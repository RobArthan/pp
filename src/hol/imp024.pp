...
********************************************************************************
% imp024.doc   ℤ $Date: 2002/10/17 15:10:58 $ $Revision: 2.5 $ $RCSfile: imp024.doc,v $
...
\def\Title{Implementation of `Oppen' Formatting Routines}

\def\AbstractText{This document contains Oppen-style formatting routines for Release 1 of ICL HOL.}

\def\Reference{DS/FMU/IED/IMP024}
...
%% LaTeX2e port: =TEX
%% LaTeX2e port: % imp024.doc   ℤ $Date: 2002/10/17 15:10:58 $ $Revision: 2.5 $ $RCSfile: imp024.doc,v $
%% LaTeX2e port: \documentstyle[hol1,11pt,TQ]{article}
%% LaTeX2e port: 
%% LaTeX2e port: \TPPtitle{Implementation of `Oppen' Formatting Routines}
%% LaTeX2e port: \TPPref{DS/FMU/IED/IMP024}
...
%% LaTeX2e port: 
%% LaTeX2e port: docsml imp024
%% LaTeX2e port: use_file "imp024.sml";
%% LaTeX2e port: 
%% LaTeX2e port: make -f rel001.mkf imp024.dvi
%% LaTeX2e port: doctex imp024
%% LaTeX2e port: texdvi imp024
%% LaTeX2e port: bibtex imp024
%% LaTeX2e port: doctex imp024 ; texdvi imp024 ; bibtex imp024
%% LaTeX2e port: doctex imp024 ; texdvi imp024
%% LaTeX2e port: dvipage imp024 &
%% LaTeX2e port: 
%% LaTeX2e port: 
%% LaTeX2e port: docsml imp024
%% LaTeX2e port: use_file "imp024.sml";
%% LaTeX2e port: 
%% LaTeX2e port: lasp -s -U imp024.doc > zz1
%% LaTeX2e port: 
%% LaTeX2e port: =TEX
...
%% LaTeX2e port: \TPPabstract{This document contains Oppen-style formatting routines for
