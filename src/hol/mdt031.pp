...
********************************************************************************
% mdt031.doc   ℤ 2004/08/24 16:03:28 2.16 mdt031.doc,v
...
%% LaTeX2e port: =TEX
%% LaTeX2e port: % mdt031.doc   ℤ 2004/08/24 16:03:28 2.16 mdt031.doc,v
...
val (dummy_fun_cv2 : PP_ENV -> TERM -> string ->TYPE -> TERM list
	-> PFUN_ANS) =
	fn _ => fn _ => fn _ => fn _ =>  fn _ => PfOk;
val (dummy_λ : PP_ENV -> TERM -> TERM -> PFUN_ANS) =
	fn _ => fn _ => fn _ => PfOk;
...
val d_funs = (dummy_λ, dummy_app, dummy_var_const, dummy_fun_cv2,
...
val gfc_3 = ⌜λ a ⦁ if a then b else c⌝;
val gfc_4 = ⌜λ a ⦁ let a = b in c⌝;
