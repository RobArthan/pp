...
The {\type}s ⓣℕ⌝, ⓣCHAR⌝ and ⓣCHAR LIST⌝ of these literals are therefore in the pervasive theories.
...
The specialisation of a universal result to a particular case in performed by the rule ⦏∀_elim⦎.
