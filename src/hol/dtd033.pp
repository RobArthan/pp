...
\def\Title{Detailed Design for Theory Lister}

\def\AbstractText{This document contains the detailed design for the theory lister module for ICL HOL.}

\def\Reference{DS/FMU/IED/DTD033}
...
%% LaTeX2e port: \TPPtitle{Detailed Design for Theory Lister}  %% Mandatory field
%% LaTeX2e port: \TPPref{DS/FMU/IED/DTD033}  %% Mandatory field
%% LaTeX2e port: \def\SCCSversion{$Revision: 2.13 $%
%% LaTeX2e port: }
%% LaTeX2e port: \TPPissue{\SCCSversion}  %% Mandatory field
%% LaTeX2e port: \TPPdate{\FormatDate{$Date: 2008/12/13 14:34:12 $ %
%% LaTeX2e port: }}
