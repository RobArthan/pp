...
********************************************************************************
% mdt084.doc   ℤ $Date: 2002/10/17 15:10:58 $ $Revision: 1.3 $ $RCSfile: mdt084.doc,v $
...
\def\Title{Module Tests for Propositional Calculus with Equality Proof Procedures}

\def\AbstractText{This document contains the module tests for the proof procedures for propositional calculus with equalities.}

\def\Reference{DS/FMU/IED/MDT084}
...
%% LaTeX2e port: =TEX
%% LaTeX2e port: % mdt084.doc   ℤ $Date: 2002/10/17 15:10:58 $ $Revision: 1.3 $ $RCSfile: mdt084.doc,v $
%% LaTeX2e port: \documentstyle[hol1,11pt,TQ]{article}
%% LaTeX2e port: 
%% LaTeX2e port: \TPPtitle{Module Tests for Propositional Calculus with Equality Proof Procedures}
%% LaTeX2e port: \def\TPPheadtitle{Module Tests for Propositional Calculus with Equality\cr Proof Procedures}
%% LaTeX2e port: \TPPref{DS/FMU/IED/MDT084}
...
%% LaTeX2e port: \TPPabstract{This document contains the module tests for the proof
%% LaTeX2e port: 	procedures for propositional calculus with equalities.}
...
=SML
run_test_a("002_1b", ⌜
∀ a1 a2 a3 b1 b2 b3 c1 c2 c3 d1 d2 t3 w1 w2 w3 x1 x2 x3 y1 y2 y3 z1 z2 z3 : ℕ ⦁
a1=b1 ∧ a1=c1 ∧ d1=c1 ∧ z1=x1 ∧ b1=y1 ∧ z1=w1 ∧ w1=y1 ∧ c1=y1 ∧
a2=b2 ∧ a2=c2 ∧ d2=c2 ∧ z2=x2 ∧ b2=y2 ∧ z2=w2 ∧ w2=y2 ∧ c2=y2 ∧ w2=92 ∧
a3=b3 ∧ a3=c3 ∧ z3=x3 ∧ z3=t3 ∧ w3=y3 ∧ z3=y3 ∧ z4
∨
...
∀ a1 a2 a3 a4 a5 b1 b2 b3 b4 b5 cv4 c1 c2 c3 c5 d1 d2 d4 d5
	t3 w1 w2 w3 w4 x1 x2 x3 x4 y1 y2 y3 y4 z1 z2 z3 z4 : ℕ ⦁
a1=b1 ∧ a1=c1 ∧ d1=c1 ∧ z1=x1 ∧ b1=y1 ∧ z1=w1 ∧ w1=y1 ∧ c1=y1 ∧
a2=b2 ∧ a2=c2 ∧ d2=c2 ∧ z2=x2 ∧ b2=y2 ∧ z2=w2 ∧ w2=y2 ∧ c2=y2 ∧ w2=92 ∧
a4=b4 ∧ a4=cf4 cv4  ∧ d4=cf4 cv4  ∧ z4=x4 ∧ b4=y4 ∧ z4=w4 ∧ w4=y4 ∧ cf4 cv4 =y4 ∧
f5 a5 = f5 b5 ∧ f5 a5 = f5a c5 ∧ f5a d5 = f5 b5 ∧
