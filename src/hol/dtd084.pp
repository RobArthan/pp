...
********************************************************************************
% dtd084.doc   ℤ $Date: 2002/10/17 15:10:58 $ $Revision: 1.5 $ $RCSfile: dtd084.doc,v $
...
\def\Title{Detailed Design of Propositional Calculus with Equality Proof Procedures}

\def\AbstractText{This document contains the detailed design of proof procedures for propositional calculus with equality.}

\def\Reference{DS/FMU/IED/DTD084}
...
%% LaTeX2e port: =TEX
%% LaTeX2e port: % dtd084.doc   ℤ $Date: 2002/10/17 15:10:58 $ $Revision: 1.5 $ $RCSfile: dtd084.doc,v $
%% LaTeX2e port: \documentstyle[hol1,11pt,TQ]{article}
%% LaTeX2e port: 
%% LaTeX2e port: \TPPtitle{Detailed Design of Propositional Calculus with Equality Proof Procedures}
%% LaTeX2e port: \def\TPPheadtitle{Detailed Design of Propositional Calculus with Equality\cr Proof Procedures}
%% LaTeX2e port: \TPPref{DS/FMU/IED/DTD084}
%% LaTeX2e port: \def\SCCSissue{$Revision: 1.5 $%
%% LaTeX2e port: }
...
%% LaTeX2e port: 	procedures for propositional calculus with equality.}
...
Given a system, Γ, of $k$ equations,
=INLINEFT
x⋎i = y⋎i
=TEX
, where the
...
a system, Δ, of $m$ equations
=INLINEFT
v⋎i = z⋎i
=TEX
\ whose conjunction is logically equivalent to that
of Γ, and such that an equation
=INLINEFT
v⋎i = v⋎j
=TEX
\ is an equational consequence of Γ iff. the equations in Δ for
=INLINEFT
v⋎i
=TEX
\ and
...
equational consequence of Γ if  it can be derived from Γ using only
