...
********************************************************************************
ℤ $Id: imp111.doc,v 1.61 2012/12/27 15:57:37 rda Exp rda $
=TEX
...
%% LaTeX2e port: =TEX
%% LaTeX2e port: % ℤ $Id: imp111.doc,v 1.61 2012/12/27 15:57:37 rda Exp rda $
...
=DUMP hol
#! /bin/sh
#	hol   From: $Id: imp111.doc,v 1.61 2012/12/27 15:57:37 rda Exp rda $ ℤ
#
...
=DUMP pp
#! /bin/sh
#	pp   From: $Id: imp111.doc,v 1.61 2012/12/27 15:57:37 rda Exp rda $ ℤ
#
...
#! /bin/sh
#	pp_make_database   From: $Id: imp111.doc,v 1.61 2012/12/27 15:57:37 rda Exp rda $ ℤ
#
...
=DUMP pp_list
#! /bin/sh
#	pp_list   From: $Id: imp111.doc,v 1.61 2012/12/27 15:57:37 rda Exp rda $ ℤ
#
