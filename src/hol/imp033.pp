...
********************************************************************************
% imp033.doc   ℤ $Date: 2012/03/17 15:01:00 $ $Revision: 1.36 $ $RCSfile: imp033.doc,v $
=TEX
...
\item[2025/03.05]
As only the Z theory lister uses $LSADTables$ and in its usage indexing brackets are not wanted around the labels,
these brackets are now unconditionally omitted. If they are required elsewhere in future a new constructor will be
