...
********************************************************************************
% ℤ $Date: 2008/02/26 09:58:29 $ $Revision: 1.42 $ $RCSfile: dtd036.doc,v $
=TEX
...
\def\AbstractText{This document contains the detailed design for the module of the {\ppfont ProofPower} system responsible for system initialisation.}

\def\Reference{DS/FMU/IED/DTD036}
...
%% LaTeX2e port: \TPPref{DS/FMU/IED/DTD036}  %% Mandatory field
%% LaTeX2e port: \def\SCCSversion{$Revision: 1.42 $%
%% LaTeX2e port: }
%% LaTeX2e port: \TPPissue{\SCCSversion}  %% Mandatory field
%% LaTeX2e port: \TPPdate{\FormatDate{$Date: 2008/02/26 09:58:29 $%
%% LaTeX2e port: }}
...
%% LaTeX2e port: This document contains the detailed design for the module of the \Product{}
%% LaTeX2e port: system responsible for system initialisation.}
