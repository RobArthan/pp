...
{\tt Xpp.totalRows} gives the number of rows in the journal window (which will be a few rows more than the number of rows in the script window, because of the space occupied by the File Name Bar) and {\tt
