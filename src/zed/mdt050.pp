...
********************************************************************************
%  mdt050.doc ℤ $Date: 2005/08/05 12:40:21 $ $Revision: 1.13 $ $RCSfile: mdt050.doc,v $
...
in
	...
	ZTmλ((dl,t, _), _) => list_term_of_z_dec dl
	|_ => fail "mdt050" 0 []
end);
=TEX
...
fun ⦏make_mdt050_sets⦎ (sl : string list) = (
	(make_mdt050_vars(map (fn s => "ℙ"^s) sl))
);
=TEX
=SML
end (* of local ... in ... *);
...
val grp_2 =
[
(mk_z_λ, λ_gen_semantic_const, "Z'λ"),
(mk_z_μ, μ_gen_semantic_const, "Z'μ"),
...
val grp_3 =
[
(mk_z_Δ⋎s, Δ⋎s_gen_semantic_const, "Z'Δ⋎s"),
(mk_z_Ξ⋎s, Ξ⋎s_gen_semantic_const, "Z'Ξ⋎s")
];
...
val d_7a = snd (make_mdt050_schs ["x", "x,y", "x,y,z"] "ℤ");
...
store_mt_results mt_run_fail [
	...
	("λ_gen_semantic_const 50001",
	λ_gen_semantic_const,
	mk_t,
	gen_fail_msg "λ_gen_semantic_const" 50001 [trues]),
	("×_gen_semantic_const 50001",
	×_gen_semantic_const,
	mk_t,
	gen_fail_msg "×_gen_semantic_const" 50001 [trues]),
	("μ_gen_semantic_const 50001",
	μ_gen_semantic_const,
	mk_t,
	gen_fail_msg "μ_gen_semantic_const" 50001 [trues]),
	...
	("Δ⋎s_gen_semantic_const 50001",
	Δ⋎s_gen_semantic_const,
	mk_t,
	gen_fail_msg "Δ⋎s_gen_semantic_const" 50001 [trues]),
	("Ξ⋎s_gen_semantic_const 50001",
	Ξ⋎s_gen_semantic_const,
	mk_t,
	gen_fail_msg "Ξ⋎s_gen_semantic_const" 50001 [trues]),
...
store_mt_results mt_run_fail [
	...
	("λ_gen_semantic_const 50001 a",
	λ_gen_semantic_const,
	a_var,
	gen_fail_msg "λ_gen_semantic_const" 50001 [a_s]),
	("×_gen_semantic_const 50001 a",
	×_gen_semantic_const,
	a_var,
	gen_fail_msg "×_gen_semantic_const" 50001 [a_s]),
	("μ_gen_semantic_const 50001 a",
	μ_gen_semantic_const,
	a_var,
	gen_fail_msg "μ_gen_semantic_const" 50001 [a_s]),
	...
	("Δ⋎s_gen_semantic_const 50001 a",
	Δ⋎s_gen_semantic_const,
	a_var,
	gen_fail_msg "Δ⋎s_gen_semantic_const" 50001 [a_s]),
	("Ξ⋎s_gen_semantic_const 50001 a",
	Ξ⋎s_gen_semantic_const,
	a_var,
	gen_fail_msg "Ξ⋎s_gen_semantic_const" 50001 [a_s]),
...
store_mt_results mt_run_fail [
	...
	λ_gen_semantic_const,
	mk_const("Z'λ[x]",BOOL),
	gen_fail_msg "λ_gen_semantic_const" 50001 [string_of_term(mk_const("Z'λ[x]",BOOL))]),
	("×_gen_semantic_const 50001 a",
	×_gen_semantic_const,
	mk_const("Z'×[x]",BOOL),
	...
	μ_gen_semantic_const,
	mk_const("Z'μ[x]",BOOL),
	gen_fail_msg "μ_gen_semantic_const" 50001 [string_of_term(mk_const("Z'μ[x]",BOOL))]),
	("∃⋎1_gen_semantic_const 50001 a",
	∃⋎1_gen_semantic_const,
	mk_const("Z'∃⋎1[x]",BOOL),
	...
	("Δ⋎s_gen_semantic_const 50001 a",
	Δ⋎s_gen_semantic_const,
	mk_const("Z'Δ⋎s[x][y]",BOOL),
	gen_fail_msg "Δ⋎s_gen_semantic_const" 50001 [string_of_term(mk_const("Z'Δ⋎s[x][y]",BOOL))]),
	("Ξ⋎s_gen_semantic_const 50001 a",
	Ξ⋎s_gen_semantic_const,
	mk_const("Z'Ξ⋎s[x][y]",BOOL),
	gen_fail_msg "Ξ⋎s_gen_semantic_const" 50001 [string_of_term(mk_const("Z'Ξ⋎s[x][y]",BOOL))]),
	("decor⋎s_gen_semantic_const 50001 a",
	decor⋎s_gen_semantic_const,
