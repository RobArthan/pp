...
********************************************************************************
%  mdt047.doc  ℤ $Date: 2007/08/04 10:50:54 $ $Revision: 1.20 $ $RCSfile: mdt047.doc,v $
...
\def\Title{Module Tests for Z Types and Terms}

\def\AbstractText{A set of module tests are given for the the constructors, destructors and discriminators of Z terms and types.}

\def\Reference{DS/FMU/IED/MDT047}
...
%% LaTeX2e port: =TEX
%% LaTeX2e port: %  mdt047.doc  ℤ $Date: 2007/08/04 10:50:54 $ $Revision: 1.20 $ $RCSfile: mdt047.doc,v $
...
%% LaTeX2e port: \TPPtitle{Module Tests for Z Types and Terms}  %% Mandatory field
%% LaTeX2e port: \def\TPPheadtitle{Module Tests for Types and Terms}
%% LaTeX2e port: \TPPref{DS/FMU/IED/MDT047}  %% Mandatory field
%% LaTeX2e port: \def\SCCSversion{$Revision: 1.20 $%
%% LaTeX2e port: }
%% LaTeX2e port: \TPPissue{\SCCSversion}  %% Mandatory field
%% LaTeX2e port: \TPPdate{\FormatDate{$Date: 2007/08/04 10:50:54 $%
%% LaTeX2e port: }}
...
%% LaTeX2e port: the constructors, destructors and discriminators of Z terms and types.}
...
"gvar_subst_3",
	(fn t => subst(gvar_subst t) t),
	⌜f:(ℕ, ℕ×ℕ)$"Z'T[2]"⌝,
	⌜z'f ($"Z'Mk_T[2]"($"z'𝕌" ($"Z'Mk_T[1]"Totality))
	 ($"z'𝕌" ($"Z'Mk_T[1]"Totality))) : (ℕ, ℕ×ℕ)$"Z'T[2]"⌝
)];
=TEX
...
=SML
add_term("Zλ",Zλ(mk_z_decl[deca],mk_z_true,vara));
add_term("Z∈",Z∈(mk_z_tuple[vara,vara],t 1));
add_term("Zλ",Zλ(mk_z_decl[decbc],mk_z_true,varb));
add_term("Z∈",Z∈(mk_z_tuple[mk_z_tuple[varb,varc],varb],t 1));
add_term("Zλ",Zλ(mk_z_decl[decsexpbcf],mk_z_true,varf));
add_term("Z∈",Z∈(mk_z_tuple[mk_z_θ(schbcf,""),varf],t 1));
add_term("Zλ",Zλ(mk_z_decl[decde,decsexpbcf,deca],mk_z_true,varf));
add_term("Z∈",Z∈(mk_z_tuple[mk_z_tuple[vard,vare,mk_z_θ(schbcf,""),vara],varf],t 1));
=TEX
\subsubsection{Definite Description}
=SML
add_term("Zμ",Zμ(mk_z_decl[deca],mk_z_true,vara));
add_term("ZEq",ZEq(vara,t 1));
add_term("Zμ",Zμ(mk_z_decl[decbc],mk_z_true,varb));
add_term("ZEq",ZEq(varb,t 1));
add_term("Zμ",Zμ(mk_z_decl[decsexpbcf],mk_z_true,varf));
add_term("ZEq",ZEq(varf,t 1));
add_term("Zμ",Zμ(mk_z_decl[decde,decsexpbcf,deca],mk_z_true,varf));
add_term("ZEq",ZEq(varf,t 1));
=TEX
...
add_term("ZDecor⋎s",ZDecor⋎s(scha,"?"));
add_term("ZDecor⋎s",ZDecor⋎s(scha,"'"));
add_term("ZEq",ZEq(mk_z_sel⋎s(mk_z_θ(scha,""),"a"),mk_z_sel⋎s(mk_z_θ(t 1,""),"a'")));
add_term("ZDecor⋎s",ZDecor⋎s(schabcdef1,"?"));
add_term("ZEq",ZEq(mk_z_sel⋎s(mk_z_θ(schabcdef1,""),"a"),mk_z_sel⋎s(mk_z_θ(t 1,""),"a?")));
add_term("ZEq",ZEq(mk_z_sel⋎s(mk_z_θ(schabcdef1,""),"a"),mk_z_sel⋎s(mk_z_θ(t 2,""),"b?")));
add_term("ZEq",ZEq(mk_z_sel⋎s(mk_z_θ(schabcdef1,""),"f"),mk_z_sel⋎s(mk_z_θ(t 3,""),"d?")));
=TEX
