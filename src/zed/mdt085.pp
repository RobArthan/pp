=IGN
********************************************************************************
mdt085.doc: this file is part of the PPZed system
...
\def\Title{Module Tests for Z Library Functions}

\def\AbstractText{This document gives the module tests for the Z Library Functions and their proof support.}

\def\Reference{DS/FMU/IED/MDT085}
...
%% LaTeX2e port: \TPPtitle{Module Tests for Z Library Functions}
%% LaTeX2e port: \TPPref{DS/FMU/IED/MDT085}  %% Mandatory field
...
%% LaTeX2e port: Z Library Functions and their proof support.}
...
\item[Issue 1.4 (1993/02/10),1.5 (1993/02/12) (10th-12th February 1993)]
...
\item[Issue 1.9 (2006/02/02)] Functional composition is now called ``∘''.
\item[2014/07/23]
...
whose detailed design is given in \cite{DS/FMU/IED/DTD085}.
...
The tests depend upon \cite{DS/FMU/IED/IMP085} and \cite{DS/FMU/IED/IMP013}.
...
=SML
val input_term = ⓩf ∈ X ↔ Y ⇒ (f ∈ X ⇸ Y ⇔ f ∘ f↗~↕ = id(ran f))⌝;
push_merge_pcs ["z_sets_ext","'z_∈_rel","'z_∈_fun"];
set_goal([], input_term);
...
=SML
use_file "dtd085.tch";
store_mt_results mt_run [("theory design of Z Functions",
