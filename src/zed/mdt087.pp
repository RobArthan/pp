...
\def\Title{Module Tests for Z Library Sequences}

\def\AbstractText{This document gives the module tests for the Z Library Sequences and their proof support.}

\def\Reference{DS/FMU/IED/MDT087}
...
%% LaTeX2e port: \TPPtitle{Module Tests for Z Library Sequences}
%% LaTeX2e port: \TPPref{DS/FMU/IED/MDT087}  %% Mandatory field
...
%% LaTeX2e port: Z Library Sequences and their proof support.}
