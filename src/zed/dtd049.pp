...
********************************************************************************
% dtd049.doc ℤ $Date: 2013/11/02 16:09:51 $ $Revision: 1.28 $ $RCSfile: dtd049.doc,v $
=TEX
...
\def\Title{Detailed Design for Z Paragraphs}

\def\AbstractText{This document contains the detailed design of the interface used to input Z specifications into the Z Proof Support System.}

\def\Reference{DS/FMU/IED/DTD049}
...
%% LaTeX2e port: \TPPtitle{Detailed Design for Z Paragraphs}  %% Mandatory field
%% LaTeX2e port: \TPPref{DS/FMU/IED/DTD049}  %% Mandatory field
%% LaTeX2e port: \def\SCCSversion{$Revision: 1.28 $%
%% LaTeX2e port: }
%% LaTeX2e port: \TPPissue{\SCCSversion}  %% Mandatory field
%% LaTeX2e port: \TPPdate{\FormatDate{$Date: 2013/11/02 16:09:51 $%
...
%% LaTeX2e port: 	interface used to input Z specifications into the Z Proof Support System.}
